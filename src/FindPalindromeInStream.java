public class FindPalindromeInStream {
    // d is the number of characters input alphabet
        ...
        for (i = 1; i < N; i++)
        {
            ...
            if (i != N - 1)
            {
                ...
                if (i % 2 == 0)
                {
                    ...
                    //
                    h = (h * d) % q;
                    int test=h *str.charAt(i / 2);
                    firstr  = (firstr + test ) % q;
                ...
                else
                {
                    ...
                    // to it.
                    int te=str.charAt((i + 1) / 2) * h;
                    second = (d * (second + q -te ) % q + str.charAt(i + 1)) % q;
                }
            }
        }
    }
